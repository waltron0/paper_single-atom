...
\textbf{\color{red}[This part is somewhat repetitive of the previous discussion to backgrounds in Fig. 2.  It needs to be adapted to tie in and not duplicate much the previous comments.]}{\color{gray}(I have put in Bill's corrs for what's here anyway though)}Very low concentrations of Cr\textsuperscript{3+} in the sapphire bulk (sub-ppb level) produce a strong fluorescence at 693~nm, with a broad tail extending to the 610-630~nm region passed by the band-pass filter.  This produces the faintly visible line through the sapphire window discussed above.  The broad fluorescence is also assigned to Cr3+, as its excitation spectrum is identical to that of the well-known lines around 693~nm.  Commercially available c-plane quality sapphire from Meller Optics and Rubicon Technologies has sufficiently low concentrations for detecting single Ba atoms.
